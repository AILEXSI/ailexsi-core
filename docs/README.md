...
| 06 | Memory Domain | **COMPLETE / GREEN** |
| 07 | Projection | **NEXT** |
...
Memory Domain — MemoryCell, MemoryVersion, Provenance, TemporalMetadata, Lifecycle via EventStore. Clean-checkout verified. See root README.
